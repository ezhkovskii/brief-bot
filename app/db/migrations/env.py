...
#import app.db.whitelist.models  # isort:skip
import app.db.chats.models
import app.db.users.models
import app.db.messages.models


postgres_dsn = make_url_sync(settings.POSTGRES_DSN).replace("%", "%%")
